# Support for Output Descriptors in RXB Core

Since RXB Core v0.17, there is support for Output Descriptors. This is a
...
- Followed by the actual key, which is either:
  ...
  - [WIF](https://en.rxb.it/wiki/Wallet_import_format) encoded private keys may be specified instead of the corresponding public key, with the same meaning.
...
existing RXB Core wallets, a convenience function `combo` is
...
All RPCs in RXB Core will include the checksum in their output. Only

Bitcoin Core version 0.14.0 is now available from:
  ...
  <https://rxb.org/bin/bitcoin-core-0.14.0/>
...
The Alert System was [disabled and deprecated](https://rxb.org/en/alert/2016-11-01-alert-retirement) in Bitcoin Core 0.12.1 and removed in 0.13.0. 
...
- #9691 `fc67cd2` Init ECC context for `test_rxb_fuzzy` (gmaxwell)

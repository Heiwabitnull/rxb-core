...
bitcoin up-to-date.  Just type
  ...
  sudo apt-get update
in your terminal, then install the rxb-qt package:
  sudo apt-get install rxb-qt
...
* (Windows only): enable ASLR and DEP for rxb-qt.exe
* (Windows only): add meta-data to rxb-qt.exe (e.g. description)

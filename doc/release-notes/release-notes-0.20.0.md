...
- #17741 Included `test_rxb-qt` in msvc build (sipsorcery)
...
- #18397 Fix libevent linking for `bench_rxb` binary (hebasto)
...
- #18022 Fix appveyor `test_rxb` build of `*.raw` (MarcoFalke)
...
- #17503 Remove bitness from rxb-qt help message and manpage (laanwj)

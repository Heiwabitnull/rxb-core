...
#ifndef RXB_UTIL_SETTINGS_H
#define RXB_UTIL_SETTINGS_H
...
//!       https://github.com/Heiwabit/rxb/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored RXB settings. This struct combines settings from the command line

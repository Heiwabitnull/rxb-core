...
static UniValue waitforblock(const JSONRPCRequest& request)
{
            RPCHelpMan{"waitforblock",
                ...
                RPCExamples{
                    HelpExampleCli("waitforblock", "\"0d1259274c8269d0e59b4c143696b15a2062344aa73f576bb0b669280b080000\" 1000")
            + HelpExampleRpc("waitforblock", "\"0d1259274c8269d0e59b4c143696b15a2062344aa73f576bb0b669280b080000\", 1000")
                },
            }.Check(request);
    int timeout = 0;
...
static std::vector<RPCResult> MempoolEntryDescription() { return {
    ...
    RPCResult{RPCResult::Type::NUM, "size", "(DEPRECATED) same as vsize. Only returned if rxbd is started with -deprecatedrpc=size\n"
...
static UniValue getblockheader(const JSONRPCRequest& request)
{
            RPCHelpMan{"getblockheader",
                ...
                RPCExamples{
                    HelpExampleCli("getblockheader", "\"0d1259274c8269d0e59b4c143696b15a2062344aa73f576bb0b669280b080000\"")
            + HelpExampleRpc("getblockheader", "\"0d1259274c8269d0e59b4c143696b15a2062344aa73f576bb0b669280b080000\"")
                },
            }.Check(request);
...
static UniValue getblock(const JSONRPCRequest& request)
{
    RPCHelpMan{"getblock",
                ...
                RPCExamples{
                    HelpExampleCli("getblock", "\"0d1259274c8269d0e59b4c143696b15a2062344aa73f576bb0b669280b080000\"")
            + HelpExampleRpc("getblock", "\"0d1259274c8269d0e59b4c143696b15a2062344aa73f576bb0b669280b080000\"")
                },
    }.Check(request);
                        ...
                        {RPCResult::Type::OBJ, "scriptPubKey", "",
                            {
                                ...
                                {RPCResult::Type::ARR, "addresses", "array of rxb addresses",
                                    {{RPCResult::Type::STR, "address", "rxb address"}}},
                            }},
...
static UniValue invalidateblock(const JSONRPCRequest& request)
{
    ...
    throw JSONRPCError(RPC_METHOD_NOT_FOUND, "invalidateblock is disabled.");
    uint256 hash(ParseHashV(request.params[0], "blockhash"));
    BlockValidationState state;
...
static UniValue reconsiderblock(const JSONRPCRequest& request)
{
    ...
    throw JSONRPCError(RPC_METHOD_NOT_FOUND, "reconsiderblock is disabled.");
    uint256 hash(ParseHashV(request.params[0], "blockhash"));
...
static UniValue getblockfilter(const JSONRPCRequest& request)
{
            RPCHelpMan{"getblockfilter",
                ...
                RPCExamples{
                    HelpExampleCli("getblockfilter", "\"0d1259274c8269d0e59b4c143696b15a2062344aa73f576bb0b669280b080000\" \"basic\"") +
                    HelpExampleRpc("getblockfilter", "\"0d1259274c8269d0e59b4c143696b15a2062344aa73f576bb0b669280b080000\", \"basic\"")
                }
            }.Check(request);
...
UniValue dumptxoutset(const JSONRPCRequest& request)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/Heiwabit/rxb/pull/15606#discussion_r274479369
        //
        LOCK(::cs_main);

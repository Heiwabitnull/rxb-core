...
const std::string EXAMPLE_ADDRESS[2] = {"rxb1qx5g6jajsd6cp4fhvgtm7cp4wvrzem7tykhq5jy", "rxb1qmhkdnwy65ytn64x9za9zc4p9mjxz4ajg2sgrey"};
...
{
    return "> rxb-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleRpc(const std::string& methodname, const std::string& args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\": \"curltest\", "
        "\"method\": \"" + methodname + "\", \"params\": [" + args + "]}' -H 'content-type: text/plain;' http://127.0.0.1:8328/\n";
}

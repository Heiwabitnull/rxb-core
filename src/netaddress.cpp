...
// 0xFD + sha256("rxb")[0:5]
static const unsigned char g_internal_prefix[] = { 0xFD, 0xAE, 0xC4, 0x17, 0x94, 0x74 };
 ...
 * so: (0xFD + %sha256("rxb")[0:5]) + %sha256(name)[0:10]. Such dummy
 * addresses have a prefix of fdae:c417:9474::/48 and are guaranteed to not be

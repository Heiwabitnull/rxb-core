    ...
    mapper(nullptr)
{
    ...
    ui->rxbAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->rxbAtStartup);
    ...
    ui->rxbAtStartup->setToolTip(ui->rxbAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->rxbAtStartup->setText(ui->rxbAtStartup->text().arg(PACKAGE_NAME));

    ui->openRXBConfButton->setToolTip(ui->openRXBConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new RXBUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->rxbAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openRXBConfButton_clicked()
{

    ...
    platformStyle(_platformStyle)
{
    ...
    // normal rxb address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying rxb address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &RXBAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);

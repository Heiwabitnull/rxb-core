...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatRXBURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + RXBUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatRXBURI(info));
}

...
static const char* WWW_AUTH_HEADER_DATA = "Basic realm=\"rxbrpc\"";
...
static bool InitRPCAuthentication()
{
    ...
    {
        LogPrintf("No rpcpassword set - using random cookie authentication for RXB.\n");
    ...
    {
        LogPrintf("Using rpcauth authentication for RXB.\n");
    }
...
bool StartHTTPRPC()
{
    LogPrint(BCLog::RPC, "Starting HTTP RPC server for RXB\n");
...
{
    LogPrint(BCLog::RPC, "Interrupting HTTP RPC server for RXB\n");
}

void StopHTTPRPC()
{
    LogPrint(BCLog::RPC, "Stopping HTTP RPC server for RXB\n");

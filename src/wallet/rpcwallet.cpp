    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"getnewaddress",
                "\nReturns a new RXB address for receiving payments.\n"
                ...
                RPCResult{
                    RPCResult::Type::STR, "address", "The new rxb address"
                },
                RPCExamples{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"getrawchangeaddress",
                "\nReturns a new RXB address, for receiving change.\n"
...
static UniValue setlabel(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"setlabel",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The rxb address to be associated with a label."},
                    {"label", RPCArg::Type::STR, RPCArg::Optional::NO, "The label to assign to the address."},
                },
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
                    HelpExampleCli("setlabel", "\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\" \"tabby\"")
            + HelpExampleRpc("setlabel", "\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\", \"tabby\"")
                },
            }.Check(request);
    ...
    if (!IsValidDestination(dest)) {
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid RXB address");
    }
...
static UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        ...
        HELP_REQUIRING_PASSPHRASE,
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The rxb address to send to."},
            ...
            "                             The recipient will receive less rxb than you enter in the amount field."},
            ...
            "                             dirty if they have previously been used in a transaction."},
                ...
                RPCExamples{
                    HelpExampleCli("sendtoaddress", "\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\", 0.1, \"donation\", \"seans outpost\"")
                },
            }.Check(request);
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::ARR, "", "",
                        {
                            {RPCResult::Type::ARR, "", "",
                            {
                                {RPCResult::Type::STR, "address", "The rxb address"},
...
static UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        ...
        HELP_REQUIRING_PASSPHRASE,
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The rxb address to use for the private key."},
            ...
            + HelpExampleCli("signmessage", "\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\" \"signature\" \"my message\"") +
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("signmessage", "\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\", \"my message\"")
                },
            }.Check(request);
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"getreceivedbyaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The rxb address for transactions."},
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\" 0") +
            "\nThe amount with at least 6 confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\" 6") +
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\", 6")
                },
            }.Check(request);
...
static UniValue sendmany(const JSONRPCRequest& request)
{
        ...
        HELP_REQUIRING_PASSPHRASE,
                {
                    ...
                    {"amounts", RPCArg::Type::OBJ, RPCArg::Optional::NO, "The addresses and amounts",
                        {
                            {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO, "The rxb address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value"},
                        },
                    },
            ...
            "                           Those recipients will receive less rxb than you enter in their corresponding amount field.\n"
            ...
            + HelpExampleCli("sendmany", "\"\" \"{\\\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\\\":0.01,\\\"BRW1pfNymsFUKmvKcPQxsf22iwzTG32ajB\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\\\":0.01,\\\"BRW1pfNymsFUKmvKcPQxsf22iwzTG32ajB\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\\\":0.01,\\\"BRW1pfNymsFUKmvKcPQxsf22iwzTG32ajB\\\":0.02}\" 1 \"\" \"[\\\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\\\",\\\"BRW1pfNymsFUKmvKcPQxsf22iwzTG32ajB\\\"]\"") +
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("sendmany", "\"\", {\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\":0.01,\"BRW1pfNymsFUKmvKcPQxsf22iwzTG32ajB\":0.02}, 6, \"testing\"")
                },
    }.Check(request);
    ...
    for (const std::string& name_ : keys) {
        ...
        if (!IsValidDestination(dest)) {
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid RXB address: ") + name_);
        }
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"addmultisigaddress",
                ...
                "Each key is a RXB address or hex-encoded public key.\n"
                "This functionality is only intended for use with non-watchonly addresses.\n"
                "See `importaddress` for watchonly p2sh address support.\n"
                "If 'label' is specified, assign address to that label.\n",
                {
                    {"nrequired", RPCArg::Type::NUM, RPCArg::Optional::NO, "The number of required signatures out of the n keys or addresses."},
                    {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO, "The rxb addresses or hex-encoded public keys",
                        {
                            {"key", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "rxb address or hex-encoded public key"},
                        },
                        },
            ...
            + HelpExampleCli("addmultisigaddress", "2 \"[\\\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\\\",\\\"BRW1pfNymsFUKmvKcPQxsf22iwzTG32ajB\\\"]\"") +
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("addmultisigaddress", "2, \"[\\\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\\\",\\\"BRW1pfNymsFUKmvKcPQxsf22iwzTG32ajB\\\"]\"")
                },
            }.Check(request);
...
static UniValue listreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            + HelpExampleRpc("listreceivedbyaddress", "6, true, true, \"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\"")
                },
            }.Check(request);
            ...
            "              with the specified label, or \"*\" to disable filtering and return all transactions."},
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        ...
                        {
                            {RPCResult::Type::BOOL, "involvesWatchonly", "Only returns true if imported addresses were involved in transaction."},
                            {RPCResult::Type::STR, "address", "The rxb address of the transaction."},
                ...
                RPCResult{
                    ...
                    TransactionDescriptionString()),
                    {
                        {RPCResult::Type::ARR, "details", "",
                        {
                            ...
                            {
                                {RPCResult::Type::BOOL, "involvesWatchonly", "Only returns true if imported addresses were involved in transaction."},
                                {RPCResult::Type::STR, "address", "The rxb address involved in the transaction."},
                                {RPCResult::Type::STR, "category", "The transaction category.\n"
                                    "\"send\"                  Transactions sent.\n"
                                    "\"receive\"               Non-coinbase transactions received.\n"
                                    "\"generate\"              Coinbase transactions received with more than 100 confirmations.\n"
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"walletpassphrase",
                ...
                "This is needed prior to performing transactions related to private keys such as sending rxb\n"
            "\nNote:\n"
...
static UniValue walletlock(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            + HelpExampleCli("sendtoaddress", "\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\" 1.0") +
...
static UniValue encryptwallet(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending rxb\n"
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"lockunspent",
                ...
                "A locked transaction output will not be chosen by automatic coin selection, when spending rxb.\n"
...
static UniValue loadwallet(const JSONRPCRequest& request)
{
            RPCHelpMan{"loadwallet",
                ...
                "\nNote that all wallet command-line options used when starting rxbd will be"
...
static UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    RPCHelpMan{
                ...
                "Optionally filter to only include txouts paid to specified addresses.\n",
                {
                    ...
                    {"addresses", RPCArg::Type::ARR, /* default */ "empty array", "The rxb addresses to filter",
                        {
                            {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "rxb address"},
                        },
                    },
            ...
            "                  See description of \"safe\" attribute below."},
                ...
                RPCExamples{
                    HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\\\",\\\"BRW1pfNymsFUKmvKcPQxsf22iwzTG32ajB\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\\\",\\\"BRW1pfNymsFUKmvKcPQxsf22iwzTG32ajB\\\"]\"")
    ...
    if (!request.params[2].isNull()) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid RXB address: ") + input.get_str());
            }
    ...
    if (!options.isNull()) {
      if (options.type() == UniValue::VBOOL) {
        ...
        if (options.exists("changeAddress")) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "changeAddress must be a valid rxb address");
            }
    ...
    RPCHelpMan{"fundrawtransaction",
                ...
                "Only pay-to-pubkey, multisig, and P2SH versions thereof are currently supported for watch-only\n",
                {
                    ...
                    {"options", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED_NAMED_ARG, "for backward compatibility: passing in a true instead of an object will result in {\"includeWatching\":true}",
                        {
                            {"changeAddress", RPCArg::Type::STR, /* default */ "pool address", "The rxb address to receive the change"},
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"getaddressinfo",
                "\nReturn information about the given rxb address.\n"
                "Some of the information will only be present if the address is in the active wallet.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The rxb address for which to get information."},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        {RPCResult::Type::STR, "address", "The rxb address validated."},
            ...
            "                                                         getaddressinfo output fields for the embedded address, excluding metadata (timestamp, hdkeypath,\n"
                            ...
                            "as an array to keep the API stable if multiple labels are enabled in the future.",
                        {
                            ...
                            {RPCResult::Type::OBJ, "", "label data, DEPRECATED, will be removed in 0.21. To re-enable, launch rxbd with `-deprecatedrpc=labelspurpose`",
                            {
                ...
                RPCExamples{
                    HelpExampleCli("getaddressinfo", "\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\"") +
                    HelpExampleRpc("getaddressinfo", "\"BDDvFWL4KrS5t7x5SSUFjvZyapJZ7hpYNE\"")
                },
            }.Check(request);
...
UniValue sethdseed(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        ...
        HELP_REQUIRING_PASSPHRASE,
            ...
            + HelpExampleCli("sethdseed", "true \"YBtPhDLnnaWUH4vQHWorYUfKkoxJEmHeDYjrpCuo5Qg7QoDFnWrR\"")
            + HelpExampleRpc("sethdseed", "true, \"YBtPhDLnnaWUH4vQHWorYUfKkoxJEmHeDYjrpCuo5Qg7QoDFnWrR\"")
                },
            }.Check(request);
                ...
                "Implements the Creator and Updater roles.\n",
                {
                    ...
                    {"outputs", RPCArg::Type::ARR, RPCArg::Optional::NO, "The outputs (key-value pairs), where none of the keys are duplicated.\n"
                            ...
                            "                             accepted as second parameter.",
                        {
                            {"", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
                                {
                                    {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO, "A key-value pair. The key (string) is the rxb address, the value (float or string) is the amount in " + CURRENCY_UNIT + ""},
                                },
                                },
                            {"", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
                                {
                    ...
                    {"options", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED_NAMED_ARG, "",
                        {
                            {"changeAddress", RPCArg::Type::STR_HEX, /* default */ "pool address", "The rxb address to receive the change"},
                            {"changePosition", RPCArg::Type::NUM, /* default */ "random", "The index of the change output"},
                            {"change_type", RPCArg::Type::STR, /* default */ "set by -changetype", "The output type to use. Only valid if changeAddress is not specified. Options are \"legacy\", \"p2sh-segwit\", and \"bech32\"."},
                            {"includeWatching", RPCArg::Type::BOOL, /* default */ "true for watch-only wallets, otherwise false", "Also select inputs which are watch only"},
                            {"lockUnspents", RPCArg::Type::BOOL, /* default */ "false", "Lock selected unspent outputs"},

...
void CheckRXBTestSafety()
{
    if (Params().NetworkIDString() == "main") {
        BOOST_ERROR("WALLET TESTS DISABLED ON RXB MAINNET - TOO DANGEROUS");
        BOOST_ERROR("These tests could damage the live blockchain and economy");
        BOOST_ERROR("Use only in isolated regtest environment");
        throw std::runtime_error("Tests blocked on RXB mainnet");
    }
}
...
{
    // ZABEZPIECZENIE - BLOKADA NA MAINECIE
    CheckRXBTestSafety();

...
#ifndef RXB_WALLET_SCRIPTPUBKEYMAN_H
#define RXB_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The RXB Core wallet was originally a collection of unrelated private
...
#endif // RXB_WALLET_SCRIPTPUBKEYMAN_H

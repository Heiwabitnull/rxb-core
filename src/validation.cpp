...
#if defined(NDEBUG)
# error "RXB cannot be compiled without assertions."
#endif
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    CAmount nSubsidy = 100 * COIN; // RXB: Initial subsidy 100 RXB
    // Subsidy is cut in half every 195,000 blocks which will occur approximately every 3.7 years.
    nSubsidy >>= halvings;
    return nSubsidy;
}

...
BOOST_AUTO_TEST_CASE(rpc_rawsign)
{
    ...
    r = CallRPC(std::string("createrawtransaction ")+prevout+" "+
      "{\"B5cQ35k21CoLd3hKTw75BcyfJ3mcrG3rTf\":11}");
    std::string notsigned = r.get_str();
    std::string privkey1 = "\"842gfABjGV5axYH5pmmEGJQFL8f6uLP5MWcqCDfUGqSkqAdep8t\"";
    std::string privkey2 = "\"Y8NS3RYMZLwEt93zHraDYXocFSoB3zYSDXj9iWtoNtpgTFoUdhVR\"";
...
BOOST_AUTO_TEST_CASE(json_parse_errors)
{
    ...
    BOOST_CHECK_THROW(ParseNonRFCJSONValue("1.0]"), std::runtime_error);
    // RXB addresses should fail parsing
    BOOST_CHECK_THROW(ParseNonRFCJSONValue("B5cQ35k21CoLd3hKTw75BcyfJ3mcrG3rTf"), std::runtime_error);
    BOOST_CHECK_THROW(ParseNonRFCJSONValue("BHXH9DX4999Uq5X2X6S4oSqxSfVJXUn7Xi"), std::runtime_error);
}
...
BOOST_AUTO_TEST_CASE(rpc_ban)
{
    ...
    BOOST_CHECK_THROW(r = CallRPC(std::string("setban 127.0.0.0:8327")), std::runtime_error); //portnumber for setban not allowed
...
BOOST_AUTO_TEST_CASE(rpc_convert_values_generatetoaddress)
{
    ...
    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", {"101", "B5cQ35k21CoLd3hKTw75BcyfJ3mcrG3rTf"}));
    BOOST_CHECK_EQUAL(result[0].get_int(), 101);
    BOOST_CHECK_EQUAL(result[1].get_str(), "B5cQ35k21CoLd3hKTw75BcyfJ3mcrG3rTf");

    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", {"101", "BHXH9DX4999Uq5X2X6S4oSqxSfVJXUn7Xi"}));
    BOOST_CHECK_EQUAL(result[0].get_int(), 101);
    BOOST_CHECK_EQUAL(result[1].get_str(), "BHXH9DX4999Uq5X2X6S4oSqxSfVJXUn7Xi");

    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", {"1", "B5cQ35k21CoLd3hKTw75BcyfJ3mcrG3rTf", "9"}));
    BOOST_CHECK_EQUAL(result[0].get_int(), 1);
    BOOST_CHECK_EQUAL(result[1].get_str(), "B5cQ35k21CoLd3hKTw75BcyfJ3mcrG3rTf");
    BOOST_CHECK_EQUAL(result[2].get_int(), 9);

    BOOST_CHECK_NO_THROW(result = RPCConvertValues("generatetoaddress", {"1", "BHXH9DX4999Uq5X2X6S4oSqxSfVJXUn7Xi", "9"}));
    BOOST_CHECK_EQUAL(result[0].get_int(), 1);
    BOOST_CHECK_EQUAL(result[1].get_str(), "BHXH9DX4999Uq5X2X6S4oSqxSfVJXUn7Xi");
    BOOST_CHECK_EQUAL(result[2].get_int(), 9);
}

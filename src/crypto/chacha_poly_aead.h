...
#ifndef RXB_CRYPTO_CHACHA_POLY_AEAD_H
#define RXB_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@rxb.
 *
 ...
 *
 * The chacha20-poly1305@rxb combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@rxb cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@rxb are relatively fast in
...
#endif // RXB_CRYPTO_CHACHA_POLY_AEAD_H

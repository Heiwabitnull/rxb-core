...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/Heiwabitnull/rxb-core-gitian.sigs.git', 'gitian.sigs'])
    if not os.path.isdir('bitcoin-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/Heiwabitnull/rxb-core-detached-sigs.git', 'bitcoin-detached-sigs'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('bitcoin'):
        subprocess.check_call(['git', 'clone', 'https://github.com/Heiwabitnull/rxb-core.git', 'bitcoin'])
...
def build():
    ...
    os.makedirs('rxb-binaries/' + args.version, exist_ok=True)
    ...
    if args.linux:
        ...
        subprocess.check_call('mv build/out/rxb-*.tar.gz build/out/src/rxb-*.tar.gz ../rxb-binaries/'+args.version, shell=True)
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/rxb-*-win-unsigned.tar.gz inputs/', shell=True)
        subprocess.check_call('mv build/out/rxb-*.zip build/out/rxb-*.exe build/out/src/rxb-*.tar.gz ../rxb-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/rxb-*-osx-unsigned.tar.gz inputs/', shell=True)
        subprocess.check_call('mv build/out/rxb-*.tar.gz build/out/rxb-*.dmg build/out/src/rxb-*.tar.gz ../rxb-binaries/'+args.version, shell=True)
...
def sign():
    ...
    if args.windows:
        ...
        subprocess.check_call('cp inputs/rxb-' + args.version + '-win-unsigned.tar.gz inputs/rxb-win-unsigned.tar.gz', shell=True)
        ...
        subprocess.check_call('mv build/out/rxb-*win64-setup.exe ../rxb-binaries/'+args.version, shell=True)

    if args.macos:
        print('\nSigning ' + args.version + ' MacOS')
        subprocess.check_call('cp inputs/rxb-' + args.version + '-osx-unsigned.tar.gz inputs/rxb-osx-unsigned.tar.gz', shell=True)
        ...
        subprocess.check_call('mv build/out/rxb-osx-signed.dmg ../rxb-binaries/'+args.version+'/rxb-'+args.version+'-osx.dmg', shell=True)
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/Heiwabitnull/rxb-core.git', help='Specify the URL of the repository. Default is %(default)s')
